...
def main():
    ...
    viz_parser.add_argument('--port', type=int, default=5000, help='Port to host the viewer (default: 5000)')
    viz_parser.add_argument('--dev', action='store_true', help='Run in development mode (starts Vite server)')
